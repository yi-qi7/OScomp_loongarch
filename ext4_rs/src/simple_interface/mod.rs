...
impl Ext4 {
    ...
    pub fn ext4_file_open(
        ...
        log::error!("end_ext4_file_open");

        // log::info!("path: {}, flags: {}, filetype: {}, iflags: {}, create: {}", path, flags, filetype.bits(), iflags, create);
        self.generic_open(path, &mut parent_inode_num, create, 0, &mut 0) // I replace ftype filetype.bits() with 0
    }
